namespace Station10 {
    ...
    export class DragDrop {
        ...
        constructor() {
            ...
            this.containerE = <HTMLDivElement>this.parentContainer.querySelector("#drop5");
        ...
        createDrag(): void {
            ...
            new DragElement(<HTMLElement>instance.parentContainer.querySelector("#dragE"))
        }
        ...
        check(): void {
            let aChild: HTMLParagraphElement = <HTMLParagraphElement>instance.containerA.querySelector("p");
            let bChild: HTMLParagraphElement = <HTMLParagraphElement>instance.containerB.querySelector("p");
            let cChild: HTMLParagraphElement = <HTMLParagraphElement>instance.containerC.querySelector("p");
            let dChild: HTMLParagraphElement = <HTMLParagraphElement>instance.containerD.querySelector("p");
            let eChild: HTMLParagraphElement = <HTMLParagraphElement>instance.containerE.querySelector("p");
